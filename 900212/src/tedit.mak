...
devicesetup.obj: devicesetup.c vsmain.h simpleeventhandler.h eventhandler.h defs.h globals.h

devicesetup.obj: usart2.h
...
init.obj    : init.c vsmain.h simpleeventhandler.h eventhandler.h defs.h globals.h usart2.h
...
timers.obj  : timers.c vsmain.h simpleeventhandler.h eventhandler.h usart2.h defs.h globals.h
	d:\C196\bin\c196.exe timers.c -f <<EOF 
  ${separate " &\n"  ms co pl(60) pw(120) dn(1) ot(1) sp(0) db si(d:\C196\include) omf(2) md(sa) nc nk nd}
  EOF

usart2.obj  : usart2.c usart2.h simpleeventhandler.h eventhandler.h vsmain.h defs.h globals.h
...
vsactiontooutput.obj: defs.h globals.h
...
inputs.obj  : inputs.c vsmain.h simpleeventhandler.h eventhandler.h defs.h globals.h usart2.h
	d:\C196\bin\c196.exe inputs.c -f <<EOF 
  ${separate " &\n"  ms co pl(60) pw(120) dn(1) ot(1) sp(0) db si(d:\C196\include) omf(2) md(sa) nc nk nd}
  EOF

$(PROJ).abs : devicesetup.obj generic.obj init.obj simpleeventhandler.obj timers.obj usart2.obj userloop.obj vsactiontooutput.obj vsmain.obj inputs.obj
