 ...
 * Id:          SEMLibB.h
 *
 * Function:    Header file for the SEM Library Basic version 4 definitions 
 *              and funtion prototypes.
 *
...
#if (VS_CODER_VERSION != 50000)
#error The generated files were generated by a visualSTATE Coder, which is not compliant with this version of the visualSTATE Basic API.
#endif
...
#ifndef VS_IS_EXPERT
#error Macro VS_IS_EXPERT must be defined.
#endif
#if (VS_IS_EXPERT != 0)
#error In real link mode with the Basic API, the value of the macro VS_IS_EXPERT must be 0.
#endif
#endif
 ...
 *                  or ACTION_TYPE) defined in the SEMlibB.h file and remember
...
#define SEM_InitInternalVariables   sem_init_internal_variables
#define SEM_InitExternalVariables   sem_init_external_variables
 ...
 */
#if (SEM_SIGNAL)
extern void SEM_InitSignalQueue (void);
#endif


/*
 * Name        :    SEM_SignalQueueInfo
 *
 * Description :    This function return information about the signal queue.
 *                  The function will only be avaliable if the signal queue 
 *                  is enabled and the VS System contains signals.
 *                  The function must be enabled by its VS Coder option.
 *
 * Argument    :    NofSignals:
 *                    Number of signals in signal queue.
 *
 * Return      :    None.
 *
 * Portability :    ANSI-C Compiler.
...
extern void SEM_SignalQueueInfo (SEM_SIGNAL_QUEUE_TYPE *NofSignals);
#endif
#endif


/*
 * Name        :    SEM_InitInternalVariables
 *
 * Description :    This function initializes the internal variables in the VS 
 *                  System. This function must be called together with the 
 *                  SEM_Init function.
 *                  The function will be auto generated by the VS Coder during
 *                  the code generation of a VS System if any internal 
 *                  variables are present and the appropriate VS Coder option 
 *                  has been set.
 *
 * Argument    :    None.
 *
...
extern void SEM_InitInternalVariables (void);
#endif


/*
 * Name        :    SEM_InitExternalVariables
 *
 * Description :    This function initializes the external variables in the VS 
 *                  System. This function must be called together with the 
 *                  SEM_Init function.
 *                  The function will be auto generated by the VS Coder during
 *                  the code generation of a VS System if any external 
 *                  variables are present and the appropriate VS Coder option 
 *                  has been set.
 *
 * Argument    :    None.
...
extern void SEM_InitExternalVariables (void);
#endif
 ...
 *
 * Description :    The function is used for initializing a number of
 *                  instances of a VS System. An instance is a copy
 *                  of the current states of the VS System.
 *                  The actual number of instances are determined by the 
 *                  data in the VS System.
 *
 * Argument    :    None.
 *
...
extern unsigned char SEM_InitInstances (void);
#endif
 ...
 *
 * Description :    The function is used for setting up the instance of the
 *                  VS System. The instance will be active until another
 *                  call of the function. 
 *
 * Argument    :    Instance:
 *                    The instance to be handled.
 *
 * Return      :    Completion code:
 *
 *                    SES_ACTIVE:
 *                      An attempt was made to execute the function while a 
 *                      deduct or inquiry session was active. The function is 
 *                      not executed.
 *
 *                    SES_RANGE_ERR:
 *                      The index number of the instance is invalid.
 *
 *                    SES_OKAY:
 *                      Success.
 *
 ...
 */
#if (VS_NOF_INSTANCES > 1)
extern unsigned char SEM_SetInstance (SEM_INSTANCE_TYPE Instance);
#endif
...
extern unsigned char SEM_Deduct (SEM_EVENT_TYPE EventNo, ...);
#else
extern unsigned char SEM_Deduct (SEM_EVENT_TYPE EventNo);
#endif
 ...
 * Portability :    ANSI-C Compiler.
 */
extern unsigned char SEM_GetOutput (SEM_ACTION_EXPRESSION_TYPE *ActionNo);
...
extern unsigned char SEM_GetOutputAll (SEM_ACTION_EXPRESSION_TYPE *ActionVector,
 ...
 * Portability :    ANSI-C Compiler.
 */
#if (SEM_NEXT_STATE_CHG == 0)
extern unsigned char SEM_NextState (void);
#endif
...
extern unsigned char SEM_NextStateChg (void);
#endif
 ...
 */
#if (SEM_INQUIRY == 1)
extern unsigned char SEM_Inquiry (void);
#endif
 ...
 */
#if (SEM_INQUIRY == 1)
extern unsigned char SEM_GetInput (SEM_EVENT_TYPE *EventNo,
...
extern unsigned char SEM_GetInputAll (SEM_EVENT_TYPE *EventVector, 
 ...
 */
#if (SEM_NAME == 1)
extern unsigned char SEM_Name (unsigned char IdentType, 
 ...
 */
#if (SEM_NAME_ABS == 1)
extern unsigned char SEM_NameAbs (unsigned char IdentType, 
 ...
 */
#if (SEM_EXPL == 1)
extern unsigned char SEM_Expl (unsigned char IdentType, 
  SEM_EXPLANATION_TYPE IdentNo, char *Text, unsigned short MaxSize);
#endif
 ...
 */
#if (SEM_EXPL_ABS == 1)
extern unsigned char SEM_ExplAbs (unsigned char IdentType, 
  SEM_EXPLANATION_TYPE IdentNo, char VS_TQ_RULEBASE **Text);
#endif
 ...
 */
#if (SEM_STATE == 1)
extern unsigned char SEM_State (SEM_STATE_MACHINE_TYPE StateMachineNo,
 ...
 */
#if (SEM_STATE_ALL == 1)
extern unsigned char SEM_StateAll (SEM_STATE_TYPE *StateVector, 
 ...
 */
#if (SEM_MACHINE == 1)
extern unsigned char SEM_Machine (SEM_STATE_TYPE StateNo,
...
extern unsigned char SEM_ForceState (SEM_STATE_TYPE StateNo);
#endif
 ...
 */
#if (SEM_FUNC_OLD_NAMING_STYLE)
#define sem_table_action(Table, ActionNo) (*(Table)[ActionNo])()
#else
#if (SEM_FUNCEXPHANDLING == 0)
